...
function showSelected(selectedText) {
  ...
  imgBox.addEventListener('click', function(event) {
    ...
    textBox.innerHTML = "<i>En cours de recherche: " + selectedText + "...</i>";
...
const API_KEY = 'your-Perplexity-API-KEY';
function fetch_gemini(message){
    ...
    const options = {
      ...
      body: JSON.stringify({
        ...
        "messages": [{"role": "user", "content": `Traduis moi en francais: ${message}?`}]
      })
    };
    ...
    fetch('https://api.perplexity.ai/chat/completions', options)
      ...
      .then(result => {
        ...
        console.log('Réponse de Perplexity:', response);
        ...
        textBox.innerHTML = "<h4>Traduction en francais: " + message + "</h4>" + markdownToHTML(response);
